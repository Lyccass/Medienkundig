...
export const glossarTerms: GlossarTerm[] = [
  ...
  },
  {
    ...
    full: "Beim Domain-Spoofing erstellen Kriminelle Webseiten mit Adressen, die echten Seiten zum Verwechseln ähneln – z.B. 'amaz0n.de' statt 'amazon.de'. Wer nicht genau hinschaut, gibt dort Passwörter oder Bankdaten ein.",
  ...
  },
  {
    ...
    category: "KI & Manipulation",
    short: "Computersysteme, die Aufgaben übernehmen, für die man früher menschliches Denken brauchte.",
